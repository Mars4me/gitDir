...
public class ClientWindow extends JFrame {
    ...
    public ClientWindow() {
        ...
        try {
            ...
            inMessage = new Scanner(clientSocket.getInputStream(), encoding);
            outMessage = new PrintWriter(new OutputStreamWriter(clientSocket.getOutputStream(), StandardCharsets.UTF_8) {
            });
        } catch (IOException e) {
            e.printStackTrace();
        }
                    ...
                    while (true) {
                        ...
                        if (inMessage.hasNext()) {
                            ...
                            if (inMes.indexOf(clientsInChat) == 0) {
                                ...
                                if(inMes.contains("##clean_chat##")) {
                                    jtaTextAreaMessage.setText("Чат очищен администратором" + "\n");
                                    inMes="";
                                } else {
                                    System.out.println("Код тут?");
                                    // выводим сообщение
        ...
        addWindowListener(new WindowAdapter() {
            ...
            public void windowClosing(WindowEvent e) {
                if(clientSocket==null) System.exit(0); // выход из программы в случае отсутствия сервера(не включен)
